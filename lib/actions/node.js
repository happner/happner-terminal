...
module.exports = function(opts, callback) {
  ...
  callback(null, {
    ...
    run: function(args, done) {
      ...
      if (opts.help) {
        console.log('\n-------------------------------------------------------');
        console.log('$local.*       - this component\'s view of the mesh');
        console.log('$local._mesh.* - mesh accessLevel');
        console.log('$local._root.* - root accessLevel (local process only)');
        console.log();
        console.log('Happner        - require(\'happner\');');
        console.log();
        console.log('$<tabtab>      - for more');
        console.log();
        console.log('-------------------------------------------------------');
      }
